...
INSERT INTO Transactions (CustomId, Description, TransactionDate, PurchaseAmount) VALUES
('TXN-001', 'Office Supplies - Stapler and Paper', '2024-12-15', 45.67),
('TXN-002', 'Business Lunch - Client Meeting', '2024-12-14', 125.50),
('TXN-003', 'Software License - Productivity Suite', '2024-12-13', 299.99),
('TXN-004', 'Travel Expense - Airport Parking', '2024-12-12', 35.00),
('TXN-005', 'Office Equipment - Wireless Mouse', '2024-12-11', 28.99),
('TXN-006', 'Professional Development Book', '2024-12-10', 55.75),
('TXN-007', 'Conference Registration Fee', '2024-12-09', 450.00),
('TXN-008', 'Business Cards Printing', '2024-12-08', 89.25),
('TXN-009', 'Cloud Storage Subscription', '2024-12-07', 15.99),
('TXN-010', 'Office Coffee Supply', '2024-12-06', 75.30),
('TXN-011', 'Marketing Materials - Brochures', '2024-11-25', 180.45),
('TXN-012', 'Team Building Event Catering', '2024-11-20', 320.80),
('TXN-013', 'Internet Service - Monthly Fee', '2024-11-15', 99.95),
('TXN-014', 'Training Workshop Attendance', '2024-11-10', 275.00),
('TXN-015', 'Office Furniture - Desk Chair', '2024-11-05', 189.99),
('TXN-016', 'Business Phone Service', '2024-10-30', 125.00),
('TXN-017', 'Computer Monitor Purchase', '2024-10-25', 399.99),
('TXN-018', 'Office Cleaning Service', '2024-10-20', 150.00),
('TXN-019', 'Professional Consultation Fee', '2024-10-15', 500.00),
('TXN-020', 'Presentation Equipment - Projector', '2024-10-10', 699.99);
